package com.webservicemongodb.myfirstmongodb.config;
...
import com.webservicemongodb.myfirstmongodb.dto.AuthorDTO;
import com.webservicemongodb.myfirstmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post0 = new Post(null, sdf.parse("21/03/2018"), "Partiu viagem", "Vou viajar para São Paulo.Abraços!",new AuthorDTO(maria));
